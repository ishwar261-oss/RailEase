namespace RailEase
{
    public partial class FrmMain : Form
    {
        ...
        private void btnPNRArrow_Click(object sender, EventArgs e)
        {
        ...
        private void lblNextStop_Click(object sender, EventArgs e)
        {

        }

        private void pnlPopularRoutes_Paint(object sender, PaintEventArgs e)
        {

        }

        private void pnlMumbai_Paint(object sender, PaintEventArgs e)
        {

        }

        private void picChennai_Click(object sender, EventArgs e)
        {
